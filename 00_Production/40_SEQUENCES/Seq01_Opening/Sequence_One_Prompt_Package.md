...
> **Standing prompt lesson:** Nano Banana can inject modern eyewear onto an older male subject even when not requested - always carry `glasses, eyeglasses, spectacles, eyewear` in the negative prompt for Gary, and prefer the bare-face master ref when glasses risk appears.
