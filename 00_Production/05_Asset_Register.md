# TEN LIFETIMES — Asset Register

> Inventory of every source & generated asset: where it lives, what it is, its status.

## Source reference photos (on disk)
| File | Folder | Use |
|---|---|---|
| Gary 1–5.jpg (5) | `01_Reference_Gary\` | Gary identity. Primary anchor: **gary 2.jpg** |
...
| File | Location | Note |
|---|---|---|
| TEN LIFETIMES.mp3 | `..\Tommy Ransome & The Gary Spear Experience\TEN LIFETIMES\` | Master, 5:29 |
| TEN LIFETIMES Stems (1)\ (+ .zip) | same | Isolated stems — vocal stem drives forced alignment |
| Ten Lifetimes.prproj | same | Premiere edit project |
...
| **TL-0070_Egypt_FirstRecognition_v5** | 03 | "The First Recognition" (Egypt, CRE-004) | ✅ **LOCKED** (v4 + pendant pickup; Director + EP approved; Gemini → Resolution Bridge) | NAS `04_Egypt\Stills\Selected\` → public `14_Selected/Seq01/` | 2026-06-27 |
| TL-0070 v1 / v2 / v3 / v4 | 03 | recognition | ARCHIVED (provenance) — v1/v2 selfie drift; v3 CCA-only; v4 = approved take before the pendant pickup (→ v5) | `13_Production_History/Seq01_Egypt/` | 2026-06-27 |
| **TL-0080_Egypt_FirstSmile_v2** | 04 | "The First Smile" (Egypt, CRE-006) | ✅ **LOCKED** — **APPROVED as the Performance Anchor (PRO-017)**: Director (Sam) + Gemini **GVR-007 95%** + EP (Gary) approved 2026-06-27. Fourth locked frame of Sequence One; Gary leads / Jen echoes; smile blooms in motion. | NAS `04_Egypt\Stills\Selected\` → public `14_Selected/Seq01/` | 2026-06-27 |
| TL-0080_Egypt_FirstSmile_v1 | 04 | "The First Smile" (Egypt) | ARCHIVED — Jen's smile read bigger than Gary's (asymmetry) → v2 | `13_Production_History/Seq01_Egypt/Superseded/` | 2026-06-27 |
